...
public class DeviceController {
    ...
    @PostMapping
    @PreAuthorize("hasAuthority('device.create') or hasAuthority('ADMIN')")
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasAuthority('device.update') or hasAuthority('ADMIN')")
    ...
    @GetMapping("/{id}")
    @PreAuthorize("hasAuthority('device.view') or hasAuthority('ADMIN')")
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasAuthority('device.delete') or hasAuthority('ADMIN')")
