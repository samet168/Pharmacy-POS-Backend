    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/v1/auth/**", "/api/v1/setup/**", "/api/v1/organizations/**", "/api/v1/subscription-plans/**", "/api/v1/branches/**", "/api/v1/dashboard/**", "/api/v1/roles/**", "/api/v1/reports/**", "/swagger-ui/**", "/v3/api-docs/**", "/swagger-ui.html", "/docs/**", "/swagger-resources/**", "/webjars/**").permitAll()
